...
import {
  GITHUB_EDIT_TAB_SELECTOR, getTextContentWithFormatting,
  injectAddPreviewDiv, isGithubEditsPage
} from './utils';
...
const processPage = async () => {
  ...
  if (isGithubPage.isValid) {
    ...
    await injectAddPreviewDiv(getTextContentWithFormatting(sourceDiv));
  } else {
